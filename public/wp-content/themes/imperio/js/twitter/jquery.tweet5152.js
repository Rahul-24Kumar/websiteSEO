...
(function (factory) {
    ...
    jQuery.fn.destweet = function(o){
        var s = jQuery.extend({
            modpath: jQuery('window.imperioOptions.templatepath').html()+"js/twitter/",                     // [string]   relative URL to Tweet.js mod (see https://github.com/StanScates/Tweet.js-Mod)
            ...
            jQuery(widget).off("tweet:load").on("tweet:load", function(){
				...
				jQuery.ajax({
					...
					data: {
						...
						dataType: "JSON",
						templatepath: window.imperioOptions.homePATH,
						security: jQuery('#imperio-theme-twitter').val()
			        },
